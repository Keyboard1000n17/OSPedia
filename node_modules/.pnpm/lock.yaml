  ...
  .:
    dependencies:
      ...
      eleventy-sass:
        ...
        version: 3.0.0-beta.0(@11ty/eleventy@3.1.2)
...
packages:
  ...
  eleventy-sass@3.0.0-beta.0:
    resolution: {integrity: sha512-pO+CLz3M/MgOkZ4L7zp0pCY7cxXvX23yTZBEp8vcgIr2Z8xiSfeZqhHMiz53GazJay0A8AUnhBbEfuGMI1RLXA==}
    engines: {node: '>=22.0.0'}
    peerDependencies:
...
snapshots:
  ...
  eleventy-sass@3.0.0-beta.0(@11ty/eleventy@3.1.2):
    dependencies:
      '@11ty/eleventy': 3.1.2
      debug: 4.4.3
      kleur: 4.1.5
