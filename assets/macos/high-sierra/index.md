...
favicon: high-sierra-icon.webp
order: 150
background_image: high-sierra-wallpaper.webp
info:
  icon:
  ...
  paras:
    ...
    - >
      ...
      newer devices.
carousel_images:
  - path: /macos/high-sierra/high-sierra-ui.webp
    alt: macOS High Sierra screenshot
    desc: A screenshot of macOS High Sierra.
  - path: /macos/high-sierra/high-sierra-wallpaper.webp
