...
order: 210
background_image: sonoma-light-wallpaper.webp
info:
  icon:
...
carousel_images:
  - path: /macos/sonoma/sonoma-light-ui.webp
    alt: macOS Sonoma screenshot
    desc: A screenshot of macOS Sonoma.
  - path: /macos/sonoma/sonoma-dark-ui.webp
    alt: Dark mode macOS Sonoma screenshot
    desc: A screenshot of macOS Sonoma in dark mode.
  - path: /macos/sonoma/sonoma-light-wallpaper.webp
    alt: macOS Sonoma wallpaper
    desc: The default wallpaper for macOS Sonoma.
  - path: /macos/sonoma/sonoma-dark-wallpaper.webp
    alt: macOS Sonoma dark mode wallpaper
    desc: The default dark mode wallpaper for macOS Sonoma.
  - path: /macos/sonoma/sonoma-horizon-wallpaper.webp
    alt: macOS Sonoma horizon wallpaper
    desc: The Sonoma horizon landscape, another default wallpaper.
---
