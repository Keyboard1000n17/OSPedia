...
carousel_images:
  - path: /MacPedia/Images/UI/Big_Sur-UI.webp
    alt: macOS Big Sur screenshot
    desc: A screenshot of macOS Big Sur.
  - path: /MacPedia/Images/Wallpapers/Big_Sur-wallpaper.webp
    alt: macOS Big Sur wallpaper
    desc: The default wallpaper for macOS Big Sur.
---
